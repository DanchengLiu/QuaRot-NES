...
def parser_gen():
    ...
    parser.add_argument('--no_quantize', action=argparse.BooleanOptionalAction, default=False, help='Do not quantize the model (for evaluation purpose).')
    parser.add_argument('--ngpt', action=argparse.BooleanOptionalAction, default=False, help='Enable ngpt evaluation (so that we do not fuse the non-existing norms).')
